...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        menuBarView.tabsCollectionView.backgroundColor = UIColor.init(white: 0.97, alpha: 0.97)
        ...
        //For Intial Display
        menuBarView.tabsCollectionView.selectItem(at: IndexPath.init(item: 0, section: 0), animated: true, scrollPosition: .centeredVertically)
    ...
    func viewController(At index: Int) -> UIViewController? {
        ...
        contentVC.nameLabel.text = tabs[index]
...
extension ViewController: MenuBarDelegate {
    ...
    func menuBarDidSelectItemAt(menu: MenuTabsView, index: Int) {
        ...
        if index != currentIndex {
            ...
            menuBarView.tabsCollectionView.scrollToItem(at: IndexPath.init(item: index, section: 0), at: .centeredHorizontally, animated: true)
...
extension ViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        ...
        if finished {
            if completed {
                let cvc = pageViewController.viewControllers!.first as! ContentViewController
                let newIndex = cvc.pageIndex
                menuBarView.tabsCollectionView.selectItem(at: IndexPath.init(item: newIndex, section: 0), animated: true, scrollPosition: .centeredVertically)
                menuBarView.tabsCollectionView.scrollToItem(at: IndexPath.init(item: newIndex, section: 0), at: .centeredHorizontally, animated: true)
            }
        }
